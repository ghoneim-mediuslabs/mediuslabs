          ...
          <div className="mt-12">
            <div className="p-8 rounded-2xl border border-border bg-background">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  href={t.home.portfolio.schoolMeal.demoUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  {t.home.portfolio.schoolMeal.viewDemo}
